...
IDIA_CONTAINER_PATH = ['/idia/software/containers/',HOME+'/containers/',S3HOME+'/Containers']
...
SLURM_ACCOUNT = 'b24-thunderkat-ag' # e.g. b09-mightee-ag, b19-meerlicht-ag
...
CAL_1GC_REF_POOL = ['m001','m000','m002','m003','m004','m006', 'm007', 'm008', 'm009'] 
...
DDF_CACHEHMP = 1
# [Beam]
DDF_BEAM = HOME+'/Beams/meerkat_pb_jones_cube_95channels_$(xy)_$(reim).fits' # specify beam cube of the form: meerkat_pb_jones_cube_95channels_$(xy)_$(reim).fits
DDF_BEAMNBAND= 10
DDF_DTBEAMMIN = 1
...
# [Beam]
KMS_BEAM = HOME+'/Beams/meerkat_pb_jones_cube_95channels_$(xy)_$(reim).fits'
KMS_BEAMAT = 'Facet'
KMS_DTBEAMMIN = 1
KMS_CENTRENORM = 1
