...
IDIA_CONTAINER_PATH = ['/idia/projects/thunderkat/containers/OC/',
                       '/idia/projects/thunderkat/containers/',
...
SLURM_ACCOUNT = '' # e.g. b09-mightee-ag, b24-thunderkat-ag, b19-meerlicht-ag
SLURM_RESERVATION = '' # e.g. lsp-mightee, lsp-thunderkat, lsp-meerlicht
